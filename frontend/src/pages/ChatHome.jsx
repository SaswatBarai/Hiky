...
function ChatHome() {
  ...
  const chats = [
    ...
    { id: 2, name: "Jane Smith", avatar: "/avatars/jane.jpg", lastMessage: "How are you?", time: "9:15 AM", unread: 0 },
    { id: 3, name: "Bob Johnson", avatar: "/avatars/bob.jpg", lastMessage: "See you tomorrow!", time: "Yesterday", unread: 0 },
    { id: 4, name: "Alice Brown", avatar: "/avatars/alice.jpg", lastMessage: "Thanks for the info", time: "Yesterday", unread: 1 },
    { id: 5, name: "Team Hiky", avatar: "/avatars/team.jpg", lastMessage: "Meeting at 3pm", time: "Monday", unread: 0 },
  ];
  ...
  const messages = [
    ...
    { id: 3, text: "I'm good, thanks! Just wanted to check in.", sender: "other", time: "10:28 AM" },
    { id: 4, text: "That's great to hear. I'm doing well too.", sender: "me", time: "10:30 AM" },
  ];
      ...
      >
        ...
        <div className="overflow-y-auto flex-grow">
          {chats.map((chat) => (
            <div 
              key={chat.id}
              className={`flex items-center p-3 hover:bg-accent cursor-pointer ${selectedChat === chat.id ? 'bg-accent' : ''}`}
          ...
          <>
            ...
            <div className="flex-grow p-4 overflow-y-auto bg-[#f0f0f0] dark:bg-[#2a2a2a] flex flex-col">
              {messages.map((message) => (
                <div 
                  key={message.id} 
                  className={`max-w-[70%] mb-3 ${message.sender === 'me' ? 'ml-auto' : 'mr-auto'}`}
                >
                  <Card className={`p-3 ${message.sender === 'me' ? 'bg-primary/10' : 'bg-card'}`}>
                    <p>{message.text}</p>
